...
func (r *PostgresTenantRepository) GetTenantByID(id int) (*models.Tenant, error) {
	query := `
...
func (r *PostgresTenantRepository) GetTenantsByUnitID(unitID int) ([]*models.Tenant, error) {
	query := `
		SELECT id, name, phone, aadhar_number, move_in_date, number_of_people, unit_id, created_at
		FROM tenants
		WHERE unit_id = $1
...
func (r *PostgresTenantRepository) CreateFamilyMember(familyMember *models.FamilyMember) error {
	query := `
...
func (r *PostgresTenantRepository) GetFamilyMembersByTenantID(tenantID int) ([]*models.FamilyMember, error) {
	query := `
...
func (r *PostgresTenantRepository) UpdateFamilyMember(familyMember *models.FamilyMember) error {
	query := `
