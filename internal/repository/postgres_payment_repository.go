...
func (r *PostgresPaymentRepository) CreatePayment(payment *models.Payment) error {
	query := `
...
func (r *PostgresPaymentRepository) GetPaymentByID(id int) (*models.Payment, error) {
	query := `
...
func (r *PostgresPaymentRepository) GetAllPayments() ([]*models.Payment, error) {
	query := `
		SELECT id, tenant_id, unit_id, amount, payment_date, due_date, is_paid, 
		       payment_method, upi_id, notes, created_at
		FROM payments
...
func (r *PostgresPaymentRepository) GetPaymentsByTenantID(tenantID int) ([]*models.Payment, error) {
	query := `
		SELECT id, tenant_id, unit_id, amount, payment_date, due_date, is_paid, 
		       payment_method, upi_id, notes, created_at
		FROM payments
...
func (r *PostgresPaymentRepository) GetPaymentByTenantAndMonth(tenantID int, month time.Month, year int) (*models.Payment, error) {
	query := `
		SELECT id, tenant_id, unit_id, amount, payment_date, due_date, is_paid, 
		       payment_method, upi_id, notes, created_at
		FROM payments
